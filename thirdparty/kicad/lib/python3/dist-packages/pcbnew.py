...
class EDA_TEXT(object):
    ...
    def GetEffectiveTextShapeNative(self, *args):
        r"""GetEffectiveTextShapeNative(EDA_TEXT self, bool aTriangulate=True, BOX2I aBBox=BOX2I(), EDA_ANGLE aAngle=ANGLE_0) -> std::shared_ptr< SHAPE_COMPOUND >"""
        return _pcbnew.EDA_TEXT_GetEffectiveTextShapeNative(self, *args)
...
class PCB_TEXTBOX(PCB_SHAPE, EDA_TEXT):
    ...
    def DisableBorder(self):
        r"""DisableBorder(PCB_TEXTBOX self)"""
        return _pcbnew.PCB_TEXTBOX_DisableBorder(self)
...
class FP_SHAPE(PCB_SHAPE):
    ...
    def CalcArcAngles0(self, aStartAngle, aEndAngle):
        r"""CalcArcAngles0(FP_SHAPE self, EDA_ANGLE aStartAngle, EDA_ANGLE aEndAngle)"""
        return _pcbnew.FP_SHAPE_CalcArcAngles0(self, aStartAngle, aEndAngle)

    def GetArcAngle0(self):
        r"""GetArcAngle0(FP_SHAPE self) -> EDA_ANGLE"""
        return _pcbnew.FP_SHAPE_GetArcAngle0(self)

    def SetCachedArcData0(self, aStart0, aMid0, aEnd0, aCenter0):
        r"""SetCachedArcData0(FP_SHAPE self, VECTOR2I aStart0, VECTOR2I aMid0, VECTOR2I aEnd0, VECTOR2I aCenter0)"""
        return _pcbnew.FP_SHAPE_SetCachedArcData0(self, aStart0, aMid0, aEnd0, aCenter0)
...
class FP_TEXTBOX(FP_SHAPE, EDA_TEXT):
    ...
    def IsBorderEnabled(self):
        r"""IsBorderEnabled(FP_TEXTBOX self) -> bool"""
        return _pcbnew.FP_TEXTBOX_IsBorderEnabled(self)

    def DisableBorder(self):
        r"""DisableBorder(FP_TEXTBOX self)"""
        return _pcbnew.FP_TEXTBOX_DisableBorder(self)
