    ...
    try {
      ...
      for (; ; ) {
        ...
        if (!(next_token instanceof String)) {
          System.out.println("NetClass.read_scope: String expected at '" + p_scanner.get_scope_identifier() + "'");
          return null;
        }
      ...
      if (!rules_missing) {
        ...
        for (; ; ) {
          next_token = p_scanner.next_token();
          if (next_token == null) {
            System.out.println("NetClass.read_scope: unexpected end of file at '" + p_scanner.get_scope_identifier() + "'");
            return null;
          }
          if (next_token == Keyword.CLOSED_BRACKET) {
            // end of scope
  ...
  public static ClassClass read_class_class_scope(IJFlexScanner p_scanner) {
    try {
      ...
      for (; ; ) {
        ...
        if (next_token == null) {
          System.out.println("ClassClass.read_scope: unexpected end of file at '" + p_scanner.get_scope_identifier() + "'");
          return null;
        }
        if (next_token == Keyword.CLOSED_BRACKET) {
          // end of scope
