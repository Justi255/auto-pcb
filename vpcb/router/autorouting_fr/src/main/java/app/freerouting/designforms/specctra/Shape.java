...
public abstract class Shape {
  ...
  public static PolylinePath read_polyline_path_scope(
    ...
    try {
      ...
      if (corner_list.size() < 5) {
        System.out.println("PolylinePath.read_scope: to few numbers in scope at '" + p_scanner.get_scope_identifier() + "'");
        return null;
      }
      ...
      if (next_object instanceof Double) {
        ...
        System.out.println("PolylinePath.read_scope: number expected at '" + p_scanner.get_scope_identifier() + "'");
        return null;
      }
      ...
      for (int i = 0; i < corner_arr.length; ++i) {
        ...
        if (next_object instanceof Double) {
          ...
          System.out.println("Shape.read_polygon_path_scope: number expected at '" + p_scanner.get_scope_identifier() + "'");
          return null;
        }
      }
  ...
  public static ReadAreaScopeResult read_area_scope(
    ...
    try {
      ...
      System.out.println("Shape.read_area_scope: IO error scanning file at '" + p_scanner.get_scope_identifier() + "'");
      return null;
    }
    ...
    if (curr_shape == null) {
      System.out.println("Shape.read_area_scope: could not read shape at '" + p_scanner.get_scope_identifier() + "'");
      result_ok = false;
    }
    ...
    for (; ; ) {
      ...
      if (next_token == null) {
        System.out.println("Shape.read_area_scope: unexpected end of file at '" + p_scanner.get_scope_identifier() + "'");
        return null;
      }
      if (next_token == Keyword.CLOSED_BRACKET) {
        // end of scope
      ...
      if (prev_token == Keyword.OPEN_BRACKET) {
        ...
        if (next_token == Keyword.WINDOW && !p_skip_window_scopes) {
          ...
          if (next_token != Keyword.CLOSED_BRACKET) {
            System.out.println("Shape.read_area_scope: closed bracket expected at '" + p_scanner.get_scope_identifier() + "'");
            return null;
          }
    ...
    try {
      ...
      for (int i = 0; i < 4; ++i) {
        ...
        if (next_token instanceof Double) {
          ...
          System.out.println("Shape.read_rectangle_scope: number expected at '" + p_scanner.get_scope_identifier() + "'");
          return null;
        }
      }
      ...
      next_token = p_scanner.next_token();
      if (next_token != Keyword.CLOSED_BRACKET) {
        System.out.println("Shape.read_rectangle_scope ) expected at '" + p_scanner.get_scope_identifier() + "'");
        return null;
      }
      if (rect_layer == null) {
        return null;
  ...
  public static Polygon read_polygon_scope(
    ...
    try {
      ...
      if (next_token == Keyword.PCB_SCOPE) {
        ...
        if (p_layer_structure == null) {
          System.out.println("Shape.read_polygon_scope: only layer types pcb or signal expected at '" + p_scanner.get_scope_identifier() + "'");
          return null;
        }
        if (!(next_token instanceof String)) {
          System.out.println("Shape.read_polygon_scope: layer name string expected at '" + p_scanner.get_scope_identifier() + "'");
          return null;
        }
      ...
      for (; ; ) {
        next_token = p_scanner.next_token();
        if (next_token == null) {
          System.out.println("Shape.read_polygon_scope: unexpected end of file at '" + p_scanner.get_scope_identifier() + "'");
          return null;
        }
        if (next_token == Keyword.OPEN_BRACKET) {
          // unknown scope
      ...
      for (int i = 0; i < coor_arr.length; ++i) {
        ...
        if (next_object instanceof Double) {
          ...
          System.out.println("Shape.read_polygon_scope: number expected at '" + p_scanner.get_scope_identifier() + "'");
          return null;
        }
      }
  ...
  public static Circle read_circle_scope(
    ...
    try {
      ...
      if (circle_layer == null) {
        System.out.println("Circle.read_circle_scope: layer with name '"+layer_name+"' not found in layer structure at '" + p_scanner.get_scope_identifier() + "'");
      }
      ...
      for (; ; ) {
        ...
        if (curr_index > 2) {
          System.out.println("Shape.read_circle_scope: closed bracket expected at '" + p_scanner.get_scope_identifier() + "'");
          return null;
        }
        if (next_token instanceof Double) {
          ...
          System.out.println("Shape.read_circle_scope: number expected at '" + p_scanner.get_scope_identifier() + "'");
          return null;
        }
        ++curr_index;
      }
  ...
  public static PolygonPath read_polygon_path_scope(
    ...
    try {
      ...
      if (corner_list.size() < 5) {
        System.out.println("Shape.read_polygon_path_scope: to few numbers in scope at '" + p_scanner.get_scope_identifier() + "'");
        return null;
      }
      if (layer == null) {
        return null;
