...
/**
 * This class is a scanner generated by <a href="http://www.jflex.de/">JFlex</a> 1.4.1 on 16.10.2008
...
class SpecctraDsnFileReader implements IJFlexScanner {
   ...
   */
  SpecctraDsnFileReader(java.io.Reader in) {
    this.zzReader = in;
  }
   ...
   */
  SpecctraDsnFileReader(java.io.InputStream in) {
  ...
  public Boolean next_closing_bracket() {
    ...
    if (next_token == null) {
      System.out.println("Network.read_net_pins: unexpected end of file");
      return false;
    }
    if (next_token != Keyword.CLOSED_BRACKET) {
      // not end of scope
      System.out.println("Network.read_net_pins: expected closed bracket is missing");
      return false;
    }
