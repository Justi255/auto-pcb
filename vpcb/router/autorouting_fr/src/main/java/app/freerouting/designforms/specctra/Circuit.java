...
public class Circuit {
  ...
  public static ReadScopeResult read_scope(IJFlexScanner p_scanner) {
    ...
    for (; ; ) {
      ...
      if (next_token == null) {
        System.out.println("Circuit.read_scope: unexpected end of file at '" + p_scanner.get_scope_identifier() + "'");
        return null;
      }
  ...
  static LengthMatchingRule read_length_scope(IJFlexScanner p_scanner) {
    ...
    for (int i = 0; i < 2; ++i) {
      ...
      if (next_token instanceof Double) {
        ...
        System.out.println("Circuit.read_length_scope: number expected at '" + p_scanner.get_scope_identifier() + "'");
        return null;
      }
    }
    ...
    for (; ; ) {
      ...
      if (next_token == null) {
        System.out.println("Circuit.read_length_scope: unexpected end of file at '" + p_scanner.get_scope_identifier() + "'");
        return null;
      }
      if (next_token == Keyword.CLOSED_BRACKET) {
        // end of scope
