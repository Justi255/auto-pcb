...
public class ShapeSearchTree45Degree extends ShapeSearchTree {
  ...
  IntOctagon calc_outside_restrained_shape(
    ...
    switch (p_obstacle_line_no) {
      ...
      default -> System.out.println("ShapeSearchTree45Degree.calc_outside_restrained_shape: p_obstacle_line_no out of range");
    }
  ...
  IntOctagon calc_inside_restrained_shape(
    ...
    switch (p_obstacle_line_no) {
      ...
      default -> System.out.println("ShapeSearchTree45Degree.calc_inside_restrained_shape: p_obstacle_line_no out of range");
    }
