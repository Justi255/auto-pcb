  ...
  for (int i = 0; i < num_nets; ++i) {
    if (net_mask[i]) {
      ...
      for (int j = netpin_start[i]; j < netpin_start[i + 1]; ++j) {
        ...
        // if(std::isnan(grad_intermediate_y[flat_netpin[j]])||std::isinf(grad_intermediate_y[flat_netpin[j]])){
        //   std::cout<<" b_x: "<<b_x<<" a_x: "<<a_x<<" b_nx: "<<b_nx<<" a_nx: "<<a_nx<<std::endl;
        //   std::cout<<" b_y: "<<b_y<<" a_y: "<<a_y<<" b_ny: "<<b_ny<<" a_ny: "<<a_ny<<std::endl;
        //   std::cout<<" xx: "<<xx<<" yy: "<<yy<<std::endl;
        //   std::cout<<" flat_netpin: "<<std::endl;
        //   for (int k = netpin_start[i]; k < netpin_start[i+1]; ++k) {
        //     std::cout << flat_netpin[k] << " ";
        //   }
        //   std::cout<<" x array: "<<std::endl;
        //   for (int k = 0; k < num_pins; ++k) {
        //     std::cout << x[k] << " ";
        //   }
        //   std::cout<<" y array: "<<std::endl;
        //   for (int k = 0; k < num_pins; ++k) {
        //     std::cout << y[k] << " ";
        //   }
        //   std::cout<<" exp_x: "<<exp_x<<" exp_nx: "<<exp_nx<<std::endl;
        //   std::cout<<" exp_y: "<<exp_y<<" exp_ny: "<<exp_ny<<std::endl;
        //   std::cout<<" xexp_x_sum: "<<xexp_x_sum<<" xexp_nx_sum: "<<xexp_nx_sum<<" exp_x_sum: "<<exp_x_sum<<" exp_nx_sum: "<<exp_nx_sum<<std::endl;
        //   std::cout<<" yexp_y_sum: "<<yexp_y_sum<<" yexp_ny_sum: "<<yexp_ny_sum<<" exp_y_sum: "<<exp_y_sum<<" exp_ny_sum: "<<exp_ny_sum<<std::endl;
