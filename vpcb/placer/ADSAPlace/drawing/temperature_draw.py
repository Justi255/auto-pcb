...
data0 = np.loadtxt('T_schedule1.txt')
data1 = np.loadtxt('T_schedule2.txt')
data2 = np.loadtxt('T_schedule3.txt')
...
# plt.figure()
ax.plot(x0, data0,label='Project 1',alpha = 0.7)
ax.plot(x1, data1,label='Origin',alpha = 0.7)
ax.plot(x2, data2,label='Project 2',alpha = 0.7)
...
# axins.plot(x0, data0,label='Old',alpha = 0.7)
# axins.plot(x1, data1,label='Project 1',alpha = 0.7)
# axins.plot(x2, data2,label='Project 2',alpha = 0.7)

#axins.plot(x,data2,color='#cba0e6',label='stride 2500',alpha=0.7)

# 局部显示并且进行连线
#zone_and_linked(ax, axins, 8450, 8500, x2 , [data0,data1,data2], 'top')
