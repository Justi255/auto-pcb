"""
Classes to manage KiCad footprints and parser for .kicad_mod files
"""
...
from pltools.kicad_parser.items.common import Image, Position, Coordinate, Net, Group, Font
from pltools.kicad_parser.items.fpitems import *
from pltools.kicad_parser.items.gritems import *
from pltools.kicad_parser.utils import sexpr
from pltools.kicad_parser.utils.strings import dequote, remove_prefix
from pltools.kicad_parser.misc.config import KIUTILS_CREATE_NEW_VERSION_STR
