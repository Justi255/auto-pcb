"""
Class to parse and generate .kicad_pcb files
"""
...
from pltools.kicad_parser.items.common import Group, Image, Net, PageSettings, TitleBlock
from pltools.kicad_parser.items.zones import Zone
from pltools.kicad_parser.items.brditems import *
from pltools.kicad_parser.items.gritems import *
from pltools.kicad_parser.items.dimensions import Dimension
from pltools.kicad_parser.utils.strings import dequote
from pltools.kicad_parser.utils.sexpr import parse_sexp
from pltools.kicad_parser.misc.config import KIUTILS_CREATE_NEW_VERSION_STR, KIUTILS_CREATE_NEW_GENERATOR_STR

from pltools.kicad_parser.kicad_mod import Footprint
...
class Board():
    ...
    tokens are found in ``kicad_parser.items.gritems``
