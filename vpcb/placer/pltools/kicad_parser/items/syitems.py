...
from pltools.kicad_parser.items.common import Fill, Position, Stroke, Effects, Fill
...
class SyTextBox():
    ...
    # NOTE: This is almost the same implementation as in ``kicad_parser.items.schitems.TextBox`` but
