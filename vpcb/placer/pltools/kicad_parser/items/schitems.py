...
from pltools.kicad_parser.items.common import Fill, Position, ColorRGBA, ProjectInstance, Stroke, Effects, Property
...
class SchematicSymbol():
    ...
    def libId(self) -> str:
        ...
        this schematic symbol references. In ``kicad_parser``, the ``lib_id`` token is a combination of
